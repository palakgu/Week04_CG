...
public class SmartWarehouseManagementSystemTest {
    ...
    void testStorage() {
        ...
        List<Electronics> electronicsItems = electronicsStorage.getItem();
    ...
    void testUtility() {
        ...
        Utility.displayAllItems(electronicsStorage.getItem());
        Utility.displayAllItems(groceriesStorage.getItem());
        Utility.displayAllItems(furnitureStorage.getItem());
    }
}
